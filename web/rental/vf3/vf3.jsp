    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf301.webp" alt="VinFast VF 6S" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf301.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf302.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf303.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf304.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf305.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf306.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf307.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf308.webp" alt="thumb8" class="thumb">

            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 3</h1>
            <div class="car-price">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 'MAINTENANCE') {
                            ...
                            window.location.href = '${pageContext.request.contextPath}/rental/modal?modelId=md01';
                        } else {
