...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/rental/vf9p/vf9p.css">
...
<body>
    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus01" alt="VinFast VF 9 Plus" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus02.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus02.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus03.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus04.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus05.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus06.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus07.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus08.webp" alt="thumb8" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9plus09.webp" alt="thumb9" class="thumb">
            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 9 Plus</h1>
            <div class="car-price">
            ...
            <div class="widget_content">
                <div class="utilities-box">
                    <div class="another-feature">
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/led_matrix.svg" alt="led_matrix"></div>
                            <div class="content">Hệ thống đèn LED Matrix thích ứng</div>
                        </div>
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/rear_air_suspension.svg" alt="rear_air_suspension"></div>
                            <div class="content">Hệ thống treo sau khí nén</div>
                        </div>
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/suction_door.svg" alt="suction_door"></div>
                            <div class="content">Cửa hít</div>
                        </div>
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/electronic_handbrake.svg" alt="electronic_handbrake"></div>
                            <div class="content">Phanh tay điện tử, chuyển số bằng nút bấm</div>
                        </div>
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/air_conditioner.svg" alt="air_conditioner"></div>
                            <div class="content">Hệ thống điều hoà 2 vùng</div>
                        </div>
                        <div class="item">
                            ...
                            <div class="content">Màn hình giải trí cảm ứng 15,6 inch hàng ghế trước</div>
                        </div>
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/speaker_system.svg" alt="speaker_system"></div>
                            <div class="content">13 loa, 1 loa trầm, 1 âm ly</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="widget_content">
                    ...
                    <div class="utilities-box">
                        <div class="deposit">
                            ...
                            <div class="content">
                                <li>Khách hàng phải thanh toán số tiền cọc là 15.000.000đ</li>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/thue-xe-tu-lai/vinfast-vf9-eco" class="similar-item">
                    <img src="${pageContext.request.contextPath}/asset/images/vf9eco01.webp" alt="VinFast VF 9 Eco">
                    <div class="similar-title">VinFast VF 9 Eco</div>
    ...
    <script src="${pageContext.request.contextPath}/rental/vf9p/vf9p.js"></script>
