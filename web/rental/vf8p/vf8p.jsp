...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/rental/vf8p/vf8p.css">
...
<body>
    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus01.webp" alt="VinFast VF 8 Plus" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus01.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus02.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus03.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus04.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus05.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus06.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus07.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf8plus08.webp" alt="thumb8" class="thumb">
            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 8 Plus</h1>
            <div class="car-price">
                ...
                <div class="utilities-box">
                    <div class="main-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">471km (WLTP)</div>
                        </div>
                        <div class="item">
            ...
            <button class="btn-book" id="btnBookCar" data-model-id="md07">Đặt xe</button>
        </section>
            ...
            <div class="widget_content">
                <div class="utilities-box">
                    <div class="another-feature">
                        ...
                        <div class="item">
                            <div class="icon"><img src="${pageContext.request.contextPath}/asset/images/sunroof.svg" alt="sunroof"></div>
                            <div class="content">Cửa sổ trời toàn cảnh</div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="content">La-zăng hợp kim 20 inch</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/thue-xe-tu-lai/vinfast-vf8-eco" class="similar-item">
                    <img src="${pageContext.request.contextPath}/asset/images/vf8eco01.webp" alt="VinFast VF 8 Eco">
                    <div class="similar-title">VinFast VF 8 Eco</div>
    ...
    <script src="${pageContext.request.contextPath}/rental/vf8p/vf8p.js"></script>
