    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s001.webp" alt="VinFast VF 6S" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s001.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s002.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s003.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s004.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s005.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s006.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s007.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s008.webp" alt="thumb8" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s009.webp" alt="thumb9" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s010.webp" alt="thumb10" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s011.webp" alt="thumb11" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s012.webp" alt="thumb12" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s013.webp" alt="thumb13" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s014.webp" alt="thumb14" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s015.webp" alt="thumb15" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf6s016.webp" alt="thumb16" class="thumb">
            </div>
        </section>
        <section class="car-inf">
                ...
                <div class="utilities-box">
                    <div class="main-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">480km (NEDC)</div>
                        </div>
                        <div class="item">
            ...
            <button class="btn-book" id="btnBookCar" data-model-id="md02">Đặt xe</button>
        </section>
                ...
                <div class="utilities-box">
                    <div class="another-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">Tích hợp HUD (Tuỳ chọn)</div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="content">La-zăng 17 inch</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/rental/vf6p/vf6p.jsp" class="similar-item">
                    <img src="${pageContext.request.contextPath}/asset/images/vf6plus001.webp" alt="VinFast VF 6 Plus">
