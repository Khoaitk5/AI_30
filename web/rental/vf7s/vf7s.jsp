...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/rental/vf7s/vf7s.css">
...
<body>
    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s001.webp" alt="VinFast VF 7S" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s001.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s002.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s003.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s004.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s005.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s006.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7s007.webp" alt="thumb7" class="thumb">
            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 7S</h1>
            <div class="car-price">
                ...
                <div class="utilities-box">
                    <div class="main-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">430km (NEDC)</div>
                        </div>
                        <div class="item">
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/thue-xe-tu-lai/vinfast-vf7-plus" class="similar-item">
                    <img src="${pageContext.request.contextPath}/asset/images/vf7plus001.webp" alt="VinFast VF 7 Plus">
                    <div class="similar-title">VinFast VF 7 Plus</div>
    ...
    <script src="${pageContext.request.contextPath}/rental/vf7s/vf7s.js"></script>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 'MAINTENANCE') {
                            ...
                            window.location.href = '${pageContext.request.contextPath}/rental/modal?modelId=md04';
                        } else {
