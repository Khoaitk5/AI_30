...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/rental/vf7p/vf7p.css">
    ...
    <script src="${pageContext.request.contextPath}/rental/modal-new/rental-modal-handler.js?v=<%= System.currentTimeMillis() %>"></script>
</head>
<body>
    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus001.webp" alt="VinFast VF 7 Plus" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus001.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus002.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus003.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus004.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus005.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus006.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus007.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf7plus008.webp" alt="thumb8" class="thumb">
            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 7 Plus</h1>
            <div class="car-price">
                ...
                <div class="utilities-box">
                    <div class="main-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">496km (NEDC)</div>
                        </div>
                        <div class="item">
                ...
                <div class="utilities-box">
                    <div class="another-feature">
                        ...
                        <div class="item">
                            ...
                            <div class="content">La-zăng 20 inch</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/thue-xe-tu-lai/vinfast-vf6-plus" class="similar-item">
    ...
    <script src="${pageContext.request.contextPath}/rental/vf7p/vf7p.js"></script>
