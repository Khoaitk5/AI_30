...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/rental/vf9e/vf9e.css">
...
<body>
    ...
    <main class="main">
        <section class="car-gallery">
            <div class="gallery-main">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco02.webp" alt="VinFast VF 9 Eco" class="gallery-img">
            </div>
            ...
            <div class="gallery-thumbs">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco02.webp" alt="thumb1" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco02.webp" alt="thumb2" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco03.webp" alt="thumb3" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco04.webp" alt="thumb4" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco05.webp" alt="thumb5" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco06.webp" alt="thumb6" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco07.webp" alt="thumb7" class="thumb">
                <img src="${pageContext.request.contextPath}/asset/images/vf9eco08.webp" alt="thumb8" class="thumb">
            </div>
        </section>
        <section class="car-inf">
            <h1 class="car-title">VinFast VF 9 Eco</h1>
            <div class="car-price">
            ...
            <button class="btn-book" id="btnBookCar" data-model-id="md08">Đặt xe</button>
        </section>
        ...
        <section class="car-similar">
            ...
            <div class="similar-list">
                <a href="${pageContext.request.contextPath}/thue-xe-tu-lai/vinfast-vf9-plus" class="similar-item">
                    <img src="${pageContext.request.contextPath}/asset/images/vf9plus01.webp" alt="VinFast VF 9 Plus">
                    <div class="similar-title">VinFast VF 9 Plus</div>
    ...
    <script src="${pageContext.request.contextPath}/rental/vf9e/vf9e.js"></script>
