...
<head>
    ...
    <title>Thêm khách hàng - TVT Future</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/customers/add" method="post" id="customerForm">
                    <div class="mb-3">
                        <label for="fullName" class="form-label">Họ tên</label>
                        <input type="text" class="form-control ${errors != null && errors.contains('Tên khách hàng không hợp lệ') ? 'is-invalid' : ''}" 
                               id="fullName" name="fullName" value="${param.fullName != null ? param.fullName : ''}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control ${errors != null && errors.contains('Email không đúng định dạng') ? 'is-invalid' : ''}" 
                               id="email" name="email" value="${param.email != null ? param.email : ''}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control ${errors != null && errors.contains('Số điện thoại phải có 10 hoặc 11 số') ? 'is-invalid' : ''}" 
                               id="phone" name="phone" value="${param.phone != null ? param.phone : ''}">
                        <span id="phoneError" class="error-message">Số điện thoại phải có 10 hoặc 11 số.</span>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Địa chỉ</label>
                        <input type="text" class="form-control" id="address" name="address" value="${param.address != null ? param.address : ''}">
                    </div>
                    <div class="mb-3">
                        <label for="licenseNumber" class="form-label">Số bằng lái</label>
                        <input type="text" class="form-control" id="licenseNumber" name="licenseNumber" value="${param.licenseNumber != null ? param.licenseNumber : ''}">
                    </div>
                    <div class="mb-3">
                        <label for="licenseExpiry" class="form-label">Ngày hết hạn bằng lái</label>
                        <input type="date" class="form-control" id="licenseExpiry" name="licenseExpiry" value="${param.licenseExpiry != null ? param.licenseExpiry : ''}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control ${errors != null && errors.contains('Số CMND/CCCD phải có 9 hoặc 12 số') ? 'is-invalid' : ''}" 
                               id="idCardNumber" name="idCardNumber" value="${param.idCardNumber != null ? param.idCardNumber : ''}">
                        <span id="idCardNumberError" class="error-message">Số CMND/CCCD phải có 9 hoặc 12 số.</span>
                    </div>
                    <div class="mb-3">
                        <label for="dateOfBirth" class="form-label">Ngày sinh</label>
                        <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="${param.dateOfBirth != null ? param.dateOfBirth : ''}">
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="membershipLevel" name="membershipLevel">
                            <option value="Bronze" ${param.membershipLevel == 'Bronze' ? 'selected' : ''}>Bronze</option>
                            <option value="Silver" ${param.membershipLevel == 'Silver' ? 'selected' : ''}>Silver</option>
                            <option value="Gold" ${param.membershipLevel == 'Gold' ? 'selected' : ''}>Gold</option>
                        </select>
                    </div>
                    <div class="mb-3">
