        ...
        form.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    // Send message to parent to update header
                    window.parent.postMessage({ type: "loginSuccess", userName: userName, userData: data.user }, "*");
                    // Close modal (assuming parent handles closing)
                    window.parent.postMessage({ type: "closeLoginModal" }, "*");
                } else {
                    // Login failed
